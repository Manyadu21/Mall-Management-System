...
file_location = "C:\\Users\\Win10 Pro\\PycharmProjects\\mall_management\\spark_data"
...
with open(csv_file_path, "w", newline="") as csvfile:
    ...
    for _ in range(1000):
        ...
        ttl_cost = price * quantity
        payment_mode = random.choice(["cash", "UPI"])

        csvwriter.writerow(
            [customer_id, store_id, product_name, sales_date.strftime("%Y-%m-%d"), sales_person_id, price, quantity, ttl_cost, payment_mode])
